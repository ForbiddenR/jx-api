...
func NewEquipRequestStartDischargingRequestError(sn, id, pod, msgId string, p *services.Protocol, err *apierrors.CallbackError) *equipRequestStartDischargingRequest {
